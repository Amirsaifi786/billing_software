        ...
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') @enderror " name="name" value="{{ old('name',$customers->name) }}" required>
                                @error('name')
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('gst_no') is-invalid @enderror" name="gst_no" value="{{ old('gst_no',$customers->gst_no) }}">
                    @error('gst_no')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
