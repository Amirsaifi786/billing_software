...
<div class="alert alert-success alert-block">
    <button type="button" class="close" data-dismiss="alert alert">×</button>
            ...
            <div class="table-top">
                ...
                <div class="wordset">
                    <ul>
                        ...
                        <li>
                        <form id="delete-form" action="{{ route('productdeleteAll') }}" method="POST">
                                @csrf
                ...
                <table class="table  datanew">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $key+1  }}</td>
                            <td>{{ $item->name }}</td>
                            <!-- Limit to 5 words and display "Read More" -->
                            <td>
                                <!-- Short Description (First 5 words) -->
                                <span class="short-description" id="short-description-{{ $item->id }}">
                                    {{ implode(' ', array_slice(explode(' ', $item->description), 0, 5)) }}
                                    @if(str_word_count($item->description) > 5)
                                    ... <a href="javascript:void(0)" class="toggle-btn" onclick="toggleDescription({{ $item->id }})">Read More</a>
                                    @endif
                                </span>

                                <!-- Full Description (Hidden by default) -->
                                <span class="full-description" id="full-description-{{ $item->id }}" style="display: none;">
                                    {{ $item->description }}
                                    <a href="javascript:void(0)" class="toggle-btn" onclick="toggleDescription({{ $item->id }})">Show Less</a>
                                </span>
                            </td>
...
<script>
    function toggleDescription(itemId) {
        // Get the short and full description elements
        var shortDescription = document.getElementById('short-description-' + itemId);
        var fullDescription = document.getElementById('full-description-' + itemId);
